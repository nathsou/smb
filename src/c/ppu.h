...
extern uint16_t ppu_t; // temporary VRAM address
extern uint8_t ppu_x; // fine X scroll (3 bits)
...
extern uint8_t ppu_scroll; // Scroll register: $2005
extern uint8_t ppu_addr; // PPU address: $2006
